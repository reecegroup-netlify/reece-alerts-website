...
export default function Header() {
  return (
    <div className="overflow-x-hidden">
      ...
      <div class="sticky top-0 z-40 w-full backdrop-blur flex-none transition-colors duration-500 lg:z-50 lg:border-b lg:border-slate-900/10 dark:border-slate-50/[0.06] bg-white supports-backdrop-blur:bg-white/60 dark:bg-transparent">
        <Container>
          <div class="max-w-8xl mx-auto">
            <div class="py-4 sm:py-5 border-b border-slate-900/10 lg:border-0 dark:border-slate-300/10 flow-root">
              <div class="relative flex items-center -mx-4 sm:-mx-6">
                {/* header - logo */}
                <a class="flex-none overflow-hidden py-2 px-4 sm:px-6" href="/">
                  <span class="sr-only">Reece</span>

                  <svg
                    fill="none"
                    xmlns="http://www.w3.org/2000/svg"
                    className={`w-[70px] sm:w-[110px] h-auto`}
                    viewBox="0 0 110 41"
                  >
                    <g clip-path="url(#a)">
                      <mask
                ...
                {/* header - site name */}
                {/* border added here as text stacks on small screens */}
                <div className="py-1 md:py-2.5 px-4 sm:px-6 border-l border-[#D9D9D9]">
                  <span className="color-[#575756] text-lg sm:text-xl font-medium leading-6 sm:leading-7 tracking-wide">
