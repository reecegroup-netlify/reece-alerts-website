...
export default function MetaList({ category,
    posted,
    updated, children, className, ...props }: MetaListProps) {
    ...
    return (
        <dl className={className ? `${classNameDefault} ${className}` : classNameDefault} {...props}>
            {posted && (
                <>
                    <dt className="mb-2 text-xs uppercase tracking-wide lg:mb-2.5 text-[#7C7575]">Posted</dt>
            ...
            {updated && (
                <>
                    <dt className="mb-2 text-xs uppercase tracking-wide lg:mb-2.5 text-[#7C7575]">Updated</dt>
                    <dd className="mb-5 whitespace-nowrap text-sm lg:mb-6">
                        <MetaDateTime dateTime={updated} />
                    </dd>
                </>
            )}
            <dt className="mb-2 text-xs uppercase tracking-wide lg:mb-2.5 text-[#7C7575]">Status</dt>
            <dd className="mb-5 whitespace-nowrap text-sm lg:mb-6">
