...
function DescriptionDetails({ children }: React.HTMLAttributes<HTMLElement>) {
  return <dd className="mb-4 whitespace-nowrap text-sm font-medium lg:mb-5">{children}</dd>
}
...
export default function MetaList({
  ...
  const initial =
    'left-0 top-0 mb-4 lg:absolute lg:left-auto lg:right-full lg:mb-5 lg:mr-[calc(6.5rem+1px)]'
